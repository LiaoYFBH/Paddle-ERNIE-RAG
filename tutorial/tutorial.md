...
#### 1.1 🧠 大模型配置
默认模型为 `ernie-4.5-turbo-vl`，如需更换请查阅 [模型列表](https://cloud.baidu.com/doc/qianfan-docs/s/7m95lyy43)。
> **注意**：为了保证对文档图片信息的理解，推荐您使用多模态大模型。
...
| 平台类型 | 获取方式 |
| :--- | :--- |
| **百度千帆 API** | [请注册并登录，然后获取API Key](https://console.bce.baidu.com/qianfan/ais/console/apiKey) |
| **AI Studio** | [打开网页登录，点击“令牌”，获取 Token](https://aistudio.baidu.com) |

#### 1.2 🔢 向量模型 (Embedding) 配置
默认模型为 `embedding-v1` ([模型列表](https://cloud.baidu.com/doc/qianfan-docs/s/7m95lyy43#%E5%90%91%E9%87%8F))。
