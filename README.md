...
结合 百度 ERNIE 4.5 的强大语义理解能力和 Milvus 向量数据库，实现了“所问即所得”的精准溯源问答。系统针对 CPU 环境进行了深度优化，支持本地离线模式 (Milvus Lite)，无需复杂服务器即可部署。
...
4. 精准问答与溯源
   提问后，系统会展示检索到的参考片段，并标注精准的页码和相关性得分。点击即可验证来源。
5. 图表与知识融合
...
### 4. 精准问答与溯源
提问后，系统会展示检索到的参考片段，并标注**精准的页码**和**相关性得分**。点击即可验证来源。
![智能问答](images/演示4.jpg)
